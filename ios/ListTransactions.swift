    ...
    do {
        ...
        case "pending",
            ...
            transactions = transactions + synchronizer.pendingTransactions.map {
              return CompactTransaction(address: $0.toAddress, amount: $0.value, dbType: "pending", time: $0.createTime, txid: $0.transactionEntity.transactionId.toHexStringTxId(), height: $0.minedHeight, localAddrs: addressList).toJson()
            }
        ...
        case "cleared":
            transactions = transactions + synchronizer.clearedTransactions.map {
              return CompactTransaction(address: $0.toAddress, amount: $0.value, dbType: "cleared", time: $0.blockTimeInSeconds, txid: $0.transactionEntity.transactionId.toHexStringTxId(), height: $0.minedHeight, localAddrs: addressList).toJson()
            }
        ...
        case "received":
            transactions = transactions + synchronizer.receivedTransactions.map {
              return CompactTransaction(address: $0.toAddress, amount: $0.value, dbType: "received", time: $0.blockTimeInSeconds, txid: $0.transactionEntity.transactionId.toHexStringTxId(), height: $0.minedHeight, localAddrs: addressList).toJson()
            }
        ...
        case "sent":
            transactions = transactions + synchronizer.sentTransactions.map {
              return CompactTransaction(address: $0.toAddress, amount: $0.value, dbType: "sent", time: $0.blockTimeInSeconds, txid: $0.transactionEntity.transactionId.toHexStringTxId(), height: $0.minedHeight, localAddrs: addressList).toJson()
            }
        default:
